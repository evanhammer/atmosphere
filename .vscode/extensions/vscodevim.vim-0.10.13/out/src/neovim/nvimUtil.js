...
class Neovim {
    static initNvim(vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            const proc = child_process_1.spawn(configuration_1.Configuration.neovimPath, ['-u', 'NONE', '-N', '--embed'], {
                cwd: __dirname,
            });
    ...
    static syncVSToVim(vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield nvim.setOption('gdefault', configuration_1.Configuration.substituteGlobalFlag === true);
            ...
            yield nvim.callFunction('setpos', [
                '.',
            ...
            yield nvim.callFunction('setreg', [
                '"',
                reg.text,
    ...
    static syncVimToVs(vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(`${lines.length} lines in nvime but ${textEditor_1.TextEditor.getLineCount()} in editor.`);
            ...
            vimState.currentRegisterMode =
                vimRegToVsReg[(yield nvim.callFunction('getregtype', ['"']))];
