...
function ContactPersonForm({firstName, action, frequencyInDays, idealNextDate, lastEventDate, daysSinceLastEvent, onContactedClick, onScheduledEventClick, onDoneEventClick}) {
    $_$wf(43);
    return $_$w(43, 1), (
        <form>
      ...
      <Button className='contacted-button' raised color='primary'
                onClick={onContactedClick}>
        Yes, contacted them
      </Button>
      <Button className='scheduled-event-button' raised color='inherit'
                onClick={onScheduledEventClick}>
        Yes, made plans
      </Button>
      <Button className='done-event-button' raised color='inherit'
...
$_$w(43, 2), ContactPersonForm.propTypes = propTypes;
