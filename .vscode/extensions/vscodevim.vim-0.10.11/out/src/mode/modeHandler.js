...
class ModeHandler {
    ...
    _renderStatusBar() {
        ...
        statusBar_1.StatusBar.SetText(text.join(' '), this.currentMode.name, this.vimState.isRecordingMacro, this.currentMode.name === mode_1.ModeName.SearchInProgressMode || this.vimState.isRecordingMacro);
    }
