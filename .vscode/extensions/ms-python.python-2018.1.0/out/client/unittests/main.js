...
function onDocumentSaved(doc) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        timeoutId = setTimeout(() => discoverTests(constants_2.CommandSource.auto, doc.uri, true), 1000);
    });
}
function dispose() {
...
function registerCommands() {
    const disposables = [];
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Discover, (cmdSource = constants_2.CommandSource.commandPalette, resource) => {
        // Ignore the exceptions returned.
        // This command will be invoked else where in the extension.
        // tslint:disable-next-line:no-empty
        discoverTests(cmdSource, resource, true, true).catch(() => { });
    }));
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Run_Failed, (cmdSource = constants_2.CommandSource.commandPalette, resource) => runTestsImpl(cmdSource, resource, undefined, true)));
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Run, (cmdSource = constants_2.CommandSource.commandPalette, file, testToRun) => runTestsImpl(cmdSource, file, testToRun)));
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Debug, (cmdSource = constants_2.CommandSource.commandPalette, file, testToRun) => runTestsImpl(cmdSource, file, testToRun, false, true)));
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    ...
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Picker_UI, (cmdSource = constants_2.CommandSource.commandPalette, file, testFunctions) => displayPickerUI(cmdSource, file, testFunctions)));
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Picker_UI_Debug, (cmdSource = constants_2.CommandSource.commandPalette, file, testFunctions) => displayPickerUI(cmdSource, file, testFunctions, true)));
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Stop, (resource) => stopTests(resource)));
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_ViewOutput, (cmdSource = constants_2.CommandSource.commandPalette) => viewOutput(cmdSource)));
    ...
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Select_And_Run_Method, (cmdSource = constants_2.CommandSource.commandPalette, resource) => selectAndRunTestMethod(cmdSource, resource)));
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Select_And_Debug_Method, (cmdSource = constants_2.CommandSource.commandPalette, resource) => selectAndRunTestMethod(cmdSource, resource, true)));
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Select_And_Run_File, (cmdSource = constants_2.CommandSource.commandPalette) => selectAndRunTestFile(cmdSource)));
    // tslint:disable-next-line:no-unnecessary-callback-wrapper
    disposables.push(vscode.commands.registerCommand(constants.Commands.Tests_Run_Current_File, (cmdSource = constants_2.CommandSource.commandPalette) => runCurrentTestFile(cmdSource)));
    return disposables;
}
...
function selectAndRunTestMethod(cmdSource, resource, debug) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield runTestsImpl(cmdSource, testManager.workspaceFolder, { testFunction: [selectedTestFn.testFunction] }, debug);
    });
}
...
function discoverTests(cmdSource, resource, ignoreCache, userInitiated) {
    return __awaiter(this, void 0, void 0, function* () {
        const testManager = yield getTestManager(true, resource);
        if (!testManager) {
            return;
        ...
        if (testManager && (testManager.status !== types_2.TestStatus.Discovering && testManager.status !== types_2.TestStatus.Running)) {
            testResultDisplay = testResultDisplay ? testResultDisplay : new main_2.TestResultDisplay(outChannel, onDidChange);
