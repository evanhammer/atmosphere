        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (interpreters.length > 0) {
                ...
                if (platform.isMac &&
                    ...
                    interpreters[0].type === contracts_1.InterpreterType.Unknown) {
            ...
            yield this.shell.showErrorMessage('Python is not installed. Please download and install Python before using the extension.');
