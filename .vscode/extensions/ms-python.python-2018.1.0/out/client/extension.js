...
const serviceRegistry_6 = require("./formatters/serviceRegistry");
const interpreterSelector_1 = require("./interpreter/configuration/interpreterSelector");
const contracts_1 = require("./interpreter/contracts");
const shebangCodeLensProvider_1 = require("./interpreter/display/shebangCodeLensProvider");
const serviceRegistry_7 = require("./interpreter/serviceRegistry");
...
const serviceRegistry_8 = require("./linters/serviceRegistry");
...
const serviceRegistry_10 = require("./unittests/serviceRegistry");
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        serviceManager.addSingletonInstance(types_2.IDisposableRegistry, context.subscriptions);
        serviceManager.addSingletonInstance(types_2.IMemento, context.globalState, types_2.GLOBAL_MEMENTO);
        serviceManager.addSingletonInstance(types_2.IMemento, context.workspaceState, types_2.WORKSPACE_MEMENTO);
        ...
        serviceManager.addSingletonInstance(types_2.IOutputChannel, standardOutputChannel, constants_1.STANDARD_OUTPUT_CHANNEL);
        serviceManager.addSingletonInstance(types_2.IOutputChannel, unitTestOutChannel, constants_3.TEST_OUTPUT_CHANNEL);
        ...
        serviceManager.get(types_4.ICodeExecutionManager).registerCommands();
        const persistentStateFactory = serviceManager.get(types_2.IPersistentStateFactory);
        ...
        const interpreterVersionService = serviceContainer.get(contracts_1.IInterpreterVersionService);
        context.subscriptions.push(new interpreterSelector_1.InterpreterSelector(interpreterManager, interpreterVersionService, processService));
        ...
        context.subscriptions.push(vscode.languages.registerCodeLensProvider(PYTHON, new shebangCodeLensProvider_1.ShebangCodeLensProvider(processService)));
        ...
        const linterProvider = new linterProvider_1.LinterProvider(context, standardOutputChannel, (a, b) => Promise.resolve(false), serviceContainer);
...
function sendStartupTelemetry(activatedPromise, serviceContainer) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const logger = serviceContainer.get(types_2.ILogger);
        try {
