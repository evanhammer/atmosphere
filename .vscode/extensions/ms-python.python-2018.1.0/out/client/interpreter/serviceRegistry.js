...
function registerTypes(serviceManager) {
    ...
    serviceManager.addSingleton(types_2.IVirtualEnvironmentManager, index_3.VirtualEnvironmentManager);
    ...
    serviceManager.addSingleton(contracts_1.IInterpreterService, index_1.InterpreterManager);
}
