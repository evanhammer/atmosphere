...
let VirtualEnvService = class VirtualEnvService extends cacheableLocatorService_1.CacheableLocatorService {
    constructor(knownSearchPaths, virtualEnvMgr, versionProvider, serviceContainer) {
...
VirtualEnvService = __decorate([
    ...
    __param(1, inversify_1.inject(types_2.IVirtualEnvironmentManager)),
