...
class InterpreterSelector {
    constructor(interpreterManager, interpreterVersionService, processService) {
        this.interpreterManager = interpreterManager;
        this.processService = processService;
        this.disposables = [];
        this.disposables.push(vscode_1.commands.registerCommand(constants_1.Commands.Set_Interpreter, this.setInterpreter.bind(this)));
        this.disposables.push(vscode_1.commands.registerCommand(constants_1.Commands.Set_ShebangInterpreter, this.setShebangInterpreter.bind(this)));
    ...
    setShebangInterpreter() {
        return __awaiter(this, void 0, void 0, function* () {
            const shebang = yield new shebangCodeLensProvider_1.ShebangCodeLensProvider(this.processService).detectShebang(vscode_1.window.activeTextEditor.document);
            if (!shebang) {
                return;
            }
