...
let TerminalCodeExecutionProvider = class TerminalCodeExecutionProvider {
    ...
    executeFile(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.getTerminalService(file).sendCommand(command, launchArgs.concat(file.fsPath.toCommandArgument()));
        });
    }
    ...
    setCwdForFileExecution(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (wkspace && fileDirPath !== wkspace.uri.fsPath && fileDirPath.length > 0) {
                yield this.getTerminalService(file).sendText(`cd ${fileDirPath.toCommandArgument()}`);
            }
        });
    }
};
