declare namespace interfaces {
    ...
    interface Rebind extends Function {
        <T>(serviceIdentifier: ServiceIdentifier<T>): BindingToSyntax<T>;
    }
    interface Unbind extends Function {
        <T>(serviceIdentifier: ServiceIdentifier<T>): void;
    }
    interface IsBound extends Function {
    ...
    interface ContainerModuleCallBack extends Function {
        (bind: interfaces.Bind, unbind: interfaces.Unbind, isBound: interfaces.IsBound, rebind: interfaces.Rebind): void;
    }
