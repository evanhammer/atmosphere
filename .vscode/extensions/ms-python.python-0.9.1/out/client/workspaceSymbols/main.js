        ...
        return this.generators.map((generator) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (let counter = 0; counter < MAX_NUMBER_OF_ATTEMPTS_TO_INSTALL_AND_BUILD; counter += 1) {
                ...
                if (promptPromise) {
                    ...
                    promptPromise = installer.promptToInstall(types_1.Product.ctags, vscode_1.workspace.workspaceFolders[0].uri);
                    promptResponse = yield promptPromise;
                }
                if (promptResponse !== types_1.InstallerResponse.Installed || (!token || token.isCancellationRequested)) {
                    return;
                }
            }
        }));
